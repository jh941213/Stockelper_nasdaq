...
class HyperCLOVAChatModel(BaseChatModel):
    ...
    api_key: SecretStr = SecretStr("NTA0MjU2MWZlZTcxNDJiY6yyY6Iahpvy/4bDhr2mfucbZv7a0mH3ZmXd45WiAT5+")
    api_key_primary: SecretStr = SecretStr("J300G5CdzwUakQQHTMBDjs7GP7buywJcqSOLGP47")
    request_id: str = "e386cbe266c241e2981098db523f8ee3"
